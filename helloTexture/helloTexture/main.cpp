...
string path         = root + "/helloTexture/helloTexture";
string vertex       = path + "/shaders/shader.vs";
string fragment     = path + "/shaders/shader.fs";

string container    = path + "/images/container.jpeg";
string awesomeface  = path + "/images/awesomeface.png";
...
int main()
{
    ...
    if (data)
    {
        // note that the container.jpeg has no transparency challel, the data type is GL_RGBA
